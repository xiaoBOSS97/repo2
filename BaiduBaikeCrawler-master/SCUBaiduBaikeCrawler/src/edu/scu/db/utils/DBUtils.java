...
public class DBUtils {
    ...
    static {                                            //静态代码块，初始化数据变量
        ...
        Reader in =null;                                
        try {
        	in =new FileReader("C:\\Users\\Administrator\\IdeaProjects\\BaiduBaikeCrawler-master\\SCUBaiduBaikeCrawler\\config\\db-config\\config.properties");//config//db-config//config.properties
            properties.load(in);
